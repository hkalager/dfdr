function [AA_final, nboutperf, nbunderperf, nbnull]=preparadata_auxfun_SR(AA, outperf_SR, ...
    underperf_SR, prop_outperf, prop_underperf)
...
AA_outperf = adjustperf_SR(AA_zero_notnull(:, idx_outperf), outperf_SR);
AA_underperf =  adjustperf_SR(AA_zero_notnull(:, idx_underperf), underperf_SR);
